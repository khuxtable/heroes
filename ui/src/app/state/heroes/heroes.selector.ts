...
import { HEROES_STORE_KEY, HeroesState } from "@app/state/heroes/heroes.reducer";
import { createFeatureSelector, createSelector } from "@ngrx/store";

export const selectHeroesState = createFeatureSelector<HeroesState>(HEROES_STORE_KEY);
